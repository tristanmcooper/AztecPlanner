...
import UploadDegreeAudit from "./pages/UploadDegreeAudit";
import PlanFromScratch from "./pages/PlanFromScratch";
import DegreeOverview from "./pages/DegreeOverview";
 ...
 return (
   <Router>
     ...
     <Routes>
       ...
       <Route path="/overview" element={<DegreeOverview />} />
     </Routes>
   </Router>
 );
}