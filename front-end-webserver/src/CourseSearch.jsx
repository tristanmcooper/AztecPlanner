...
// // Course-level difficulty summary (average difficulty across profs)
// function summarizeCourseDifficulty(professors = []) {
//   if (!professors.length) return "No difficulty data";

//   const diffs = [];
//   for (const p of professors) {
//     const id = p.id != null ? String(p.id) : null;
//     const global = id ? PROFESSORS_BY_ID[id] : null;

//     const d =
//       typeof p.overall_difficulty === "number"
//         ? p.overall_difficulty
//         : global && typeof global.overall_difficulty === "number"
//         ? global.overall_difficulty
//         : null;

//     if (typeof d === "number") diffs.push(d);
//   }

//   if (!diffs.length) {
//     return `${professors.length} profs (no difficulty data)`;
//   }

//   const avgDiff = diffs.reduce((acc, d) => acc + d, 0) / diffs.length;
//   return `${professors.length} profs · avg difficulty ${avgDiff.toFixed(1)}/5`;
// }
...
//                       {summarizeCourseDifficulty(selectedCourse.professors)}
//                     </div>
...
//                           >
//                             {/* Top row: name (no link) + rating pill */}
//                             <button
//                               type="button"
